...
%nceline%
echo Nemôžem nájs PowerShell.exe v systéme.
echo Prerušenie...
goto MASend
)
...
%nceline%
echo SScenár sa spúša z doèasnej zložky,
...
echo Na tento ucel kliknite pravým tlaèítkom na tento skript a vyberte 'Otvorit za Spravcu'.
goto MASend
)
...
echo:
echo:             [4] Kuknut ci je tvuj pc aktivovany
echo:             [5] Extra
echo:             [6] Pomoc
echo:             [0] Vypnut
echo:             Tento skript bol preloženy MoonLiian (https://github.com/TopKericek)                    
echo:       ______________________________________________________________
echo:
